...
from SaveAsMat import SaveAsMat
...
#    TestIndex = args.TrainIndex
    for TestIndex in range(0,4):
        ...
        for test_dataset_id in range(4):
                ...
                test_loss = L / (i + 1)
                SaveAsMat(TestIndex,test_dataset_id,y_pred,y_test)
