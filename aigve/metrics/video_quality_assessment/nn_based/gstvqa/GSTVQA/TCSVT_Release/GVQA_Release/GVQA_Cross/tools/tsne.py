...
if __name__ == "__main__":
    ...
    if TestIndex==1:    
        ...
        model_path = "./models/training-all-data-VSFA-cvd14-EXP0-best" 
    if TestIndex==2:
        datainfo_path = "../datas/LIVE-Qualcomminfo.mat"    
        model_path = "./models/training-all-data-VSFA-liveq-EXP0-best"
    if TestIndex==3:
        datainfo_path = "../datas/LIVE_Video_Quality_Challenge_585info.mat" 
        model_path = "./models/training-all-data-VSFA-livev-EXP0-best"
    if TestIndex==4:
        datainfo_path = "../datas/KoNViD-1kinfo-original.mat" 
        model_path = "./models/training-all-data-VSFA-konvid-EXP0-best"
    ...
    for ii in range(4):
            ...
            if ii == 0:
                ...
                test_name = 'cvd'
                print('-----------cvd-----------')
                feature_path ="../VSFA_VGG16_mean_std_features/VGG16_cat_features_CVD2014_original_resolution/"
            ...
            if ii == 1:
                ...
                print('-----------LIVE-Q-----------')
                test_name = 'LIVE-Q'
                feature_path ="../VSFA_VGG16_mean_std_features/VGG16_cat_features_LIVE-Qua_1080P/"
            ...
            if ii == 2:
                ...
                print('-----------LIVE-V-----------') 
                test_name = 'LIVE-V'
                feature_path ="../VSFA_VGG16_mean_std_features/VGG_cat_features_LIVE_VQC585_originla_resolution/"
            ...
            if ii == 3:
                ...
                print('-----------KoNViD-----------')
                test_name = 'KoNViD'
                feature_path ="../VSFA_VGG16_mean_std_features/VGG16_cat_features_KoNViD_original_resolution/"  
            ...
            if ii == 4:
                ...
                print(len(test_index)) 
                print('-----------KSC-----------')
                feature_path ="../VSFA_VGG16_mean_std_features/VGG16_cat_features_KSC_1080P/"      
...
#                    print("y_test",y_test[i])
                    ...
                    outputs,frame_input = model(features, length.float(),mean_var,std_var,mean_mean,std_mean)
                    data.append(frame_input.cpu().numpy().tolist())
                    index.append(ii)
#                    print("---------------------")
...
#            print("y_test",y_test)
            ...
            np.save("npy/"+test_name+"feat.npy",data)
            np.save("npy/"+test_name+"index.npy",index) 
