...
import ast, copy, difflib, os, platform, shutil, sys, tempfile, types, uuid, warnings
...
class Config:
    ...
    Examples:
        ...
        >>> cfg.filename
        "/home/username/projects/VQA_Toolkit/tests/data/config/a.py"
        >>> cfg.item4
        'test'
        >>> cfg
        "Config [path: /home/username/projects/VQA_Toolkit/tests/data/config/a.py]
        :"
